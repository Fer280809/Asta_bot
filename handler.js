...
if (chat?.isBanned && !isROwner && !['grupo-botcontrol.js'].includes(name) && command !== 'bot') {
  return // El bot está desactivado, no procesar este comando
}
...
if (name != 'grupo-botcontrol.js' && chat?.isBanned && !isROwner && command !== 'bot')
return 
...
if (!m.fromMe) return this.sendMessage(m.chat, { react: { text: emot, key
